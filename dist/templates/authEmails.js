...
exports.emailASCSubZone = exports.emailConfirmAccount = exports.emailForSubAdminCredentials = exports.emailRecoverPassword = void 0;
const config_1 = require("../config/config");
const emailRecoverPassword = (token, name) => {
    const template = `
...
const emailForSubAdminCredentials = (username, password) => {
    const template = `
      <!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
      <html xmlns="http://www.w3.org/1999/xhtml" xmlns:o="urn:schemas-microsoft-com:office:office" style="width:100%;font-family:tahoma, verdana, segoe, sans-serif;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;padding:0;Margin:0">
        <head> 
              ...
              <table style="width:100%;">
                <tbody>
                  ...
                  <td valign="top" style="vertical-align:top;padding:0" align="center">
                    <img style="object-fit: contain; width: 100%; height:290px;" src="${config_1.HOSTNAME}/assets/logo2.png" alt="WE-U">
...
exports.emailForSubAdminCredentials = emailForSubAdminCredentials;
const emailConfirmAccount = (name, token) => {
    const template = `
      <!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
      <html xmlns="http://www.w3.org/1999/xhtml" xmlns:o="urn:schemas-microsoft-com:office:office" style="width:100%;font-family:tahoma, verdana, segoe, sans-serif;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;padding:0;Margin:0">
        <head> 
...
exports.emailConfirmAccount = emailConfirmAccount;
const emailASCSubZone = (nameASC, nameSubscriber, correo, pass) => {
    const template = `
      <!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
      <html xmlns="http://www.w3.org/1999/xhtml" xmlns:o="urn:schemas-microsoft-com:office:office" style="width:100%;font-family:tahoma, verdana, segoe, sans-serif;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;padding:0;Margin:0">
        <head> 
...
exports.emailASCSubZone = emailASCSubZone;
