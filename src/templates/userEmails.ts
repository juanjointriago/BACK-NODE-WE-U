...
import { UserPaymentInfo } from '../interfaces/auth.interfaces';
 ...
 */
export const emailConfirmation = (name: string, roleId: number) => {
  const template = `
                    ...
                    <td valign="top" style="vertical-align:top;padding:0" >
                      <div style="text-align:center">
                        ...
                        <div style="margin-bottom:10px;">
                          ...
                          <div style="margin-bottom:10px;">
                            <p>
                                ${roleId === UserRoles.SubAdmin || roleId === UserRoles.Subscriber ? 'Usted puede ingresar al Portal de Adminstración dando clic en siguiente boton' : 'Usted ya puede ingresar desde la aplicación'}
                            </p>
                          </div>
                          ${
                            roleId === UserRoles.SubAdmin || UserRoles.Subscriber
                              ? `
                              <div style="margin-bottom:10px;">
 ...
 */
export const emailPayment = ({ name, identification, numOrden, subtotal, total, iva, detail, date, dateUntil, detailsPayment }: UserPaymentInfo) => {
  const template = `
      <!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
      <html xmlns="http://www.w3.org/1999/xhtml" xmlns:o="urn:schemas-microsoft-com:office:office" style="width:100%;font-family:tahoma, verdana, segoe, sans-serif;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;padding:0;Margin:0">
        <head> 
